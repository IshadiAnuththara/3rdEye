...
class Test_AddMember_Invalid_OnlyAddEmail_FirstName_LastName:
    ...
    def test_addMember(self, setup):
        ...
        if 'Username required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addMember_"
                                                             "Invalid_OnlyAddEmail_FirstName_LastName_scr.png")  # Screenshot
