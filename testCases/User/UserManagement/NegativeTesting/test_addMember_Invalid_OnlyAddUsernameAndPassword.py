...
class Test_AddMember_Invalid_OnlyAddUsernameAndPassword:
    ...
    def test_addMember(self, setup):
        ...
        if 'Email required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addMember_Invalid_OnlyAddUsernameAndPassword_scr.png")  # Screenshot
            self.logger.error("********* Add Member - Invalid - Only Add Username And Password Test Failed ************")
            assert False
        self.driver.close()
