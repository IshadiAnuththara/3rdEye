...
class Test_AddMember_Invalid_OnlySelectActiveStatus:
    ...
    def test_addMember(self, setup):
        ...
        if 'Email required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addMember_Invalid_OnlySelectActiveStatus_scr.png")  # Screenshot
