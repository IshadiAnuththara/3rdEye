...
class Test_AddMember_Invalid_WithoutSelectActiveStatus:
    ...
    def test_addMember(self, setup):
        ...
        if 'Status required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addMember_Invalid_WithoutSelectActiveStatus_scr.png")  # Screenshot
