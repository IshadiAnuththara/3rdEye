...
class Test_AddMember_Invalid_WithoutSelectRole_And_ActiveStatus:
    ...
    def test_addMember(self, setup):
        ...
        if 'Role required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addMember_Invalid_WithoutSelectRole"
                                                             "_And_ActiveStatus_scr.png")  # Screenshot
