...
class Test_AddUserRole_Invalid_OnlyAddPermissions:
    ...
    def test_addUserRole(self, setup):
        ...
        if 'Role name required.' in self.msg:
            ...
            self.driver.save_screenshot(".\\Screenshots\\" + "test_addUserRole_Invalid_OnlyAddPermissions_scr.png")  # Screenshot
